...
const SIDEBAR_ITEMS = [
  ...
  { name: "Logout", icon: LogOut, color: "#ff0000", href: "/logout" }, // Added Logout item
];
...
const Sidebar = () => {
  ...
  return (
    ...
    >
      <div className='h-full bg-gray-200 bg-opacity-50 backdrop-blur-md p-4 flex flex-col border-r border-gray-500'>
        <motion.button
