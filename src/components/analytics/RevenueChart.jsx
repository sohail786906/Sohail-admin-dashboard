	...
	return (
		...
		>
			<div className='flex justify-between items-center mb-6'>
				<h2 className='text-xl font-semibold text-gray-800'>Revenue vs Target</h2>
				<select
					className='bg-gray-100 text-gray-800 rounded-md px-3 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500'
